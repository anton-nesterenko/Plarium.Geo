namespace Plarium.Geo.Services
{
    ...
    {
        public const string DefaultOffset = "+00";

        private readonly Dictionary<string, string> _timezoneOffsetDictionary;
        private readonly Dictionary<string, string> _countryOffsetDictionary;

        public TimezoneService()
        {
            _timezoneOffsetDictionary = new Dictionary<string, string>
                                            {
                                                {"Europe/Andorra","+01"},
                                                {"Asia/Dubai","+04"},
                                                {"Asia/Kabul","+04:30"},
            ...
            _countryOffsetDictionary = new Dictionary<string, string>
                                           {
                                               {"AD","+01"},
                                               {"AE","+04"},
                                               {"AF","+04:30"},
        ...
        {
            var offset = !string.IsNullOrEmpty(timezone) ? GetUtcOffsetByTimezone(timezone) : GetUtcOffsetByCountry(countryCode);
            return offset;
        }
        ...
        {
            string offset;
            if (!_countryOffsetDictionary.TryGetValue(countryCode, out offset))
            {
        ...
        {
            string offset;
            if (!_timezoneOffsetDictionary.TryGetValue(timezone, out offset))
            {
                offset = DefaultOffset;
            }
        ...
        protected byte TimezoneToByte(string code)
        {
