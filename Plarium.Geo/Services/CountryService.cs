namespace Plarium.Geo.Services
{
    ...
    internal class CountryService : ICountryService
    {
        ...
        private readonly short[] _countryDialCode;
...
"Saint Barthelemy","Saint Martin", "Bonaire, Saint Eustatius and Saba", "South Sudan"};
            ...
            _maxIndex = _countryCode.Length - 1;
        }
        ...
        public string GetCountryName(byte code)
        {
            ...
            return _countryName[index > _maxIndex ? 0 : index];
        }

        public string GetCountryCode(byte code)
        {
            var index = Convert.ToInt32(code);
            return _countryCode[index > _maxIndex ? 0 : index];
        }
